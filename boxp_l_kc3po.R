...
output2_1=output[,order(paramterIndices[1:36,4])]
output2_2=output[,37:72]
output2_2=output2_2[,order(paramterIndices[37:72,4])]
...
Cairo::CairoPDF(file="kc3po_div_BP_1000.pdf",height=6.5,width=11)
makePlot(output2_1)
...
Cairo::CairoPDF(file="kc3po_div_BP_2500.pdf",height=6.5,width=11)
makePlot(output2_2)
