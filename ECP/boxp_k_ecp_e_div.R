...
save_dirr=""
Cairo::CairoPDF(file=paste(save_dirr,"ECP_div_kpb.pdf",sep=""),height=6,width=10)
makeBP(output)
dev.off()
...
Cairo::CairoPDF(file=paste(save_dirr,"kbp_ecp_div_1000.pdf",sep=""),height=7.5,width=14)
makeBigPlot(output[,order(dimss)])
title("N=1000, Scenario 1, E.DIV",cex.main=2.5)
dev.off()
...
Cairo::CairoPDF(file=paste(save_dirr,"kbp_ecp_div_2500.pdf",sep=""),height=7.5,width=14)
makeBigPlot(output[,order(dimss)])
title("N=2500, Scenario 1, E.DIV",cex.main=2.5)
dev.off()
...
Cairo::CairoPDF(file=paste(save_dirr,"kbp_ecp_div_5000.pdf",sep=""),height=7.5,width=14)
makeBigPlot(output[,order(dimss)])
title("N=5000, Scenario 1, E.DIV",cex.main=2.5)
dev.off()
