...
#order by dimension'
output2_1=output[,1:36]
output2_2=output[,37:72]
output2_3=output[,73:108]
output2_1=output2_1[,order(paramterIndices[1:36,4])]
output2_2=output2_2[,order(paramterIndices[1:36,4])]
output2_3=output2_3[,order(paramterIndices[1:36,4])]
...
Cairo::CairoPDF(file="fast_ecp_div_BP_1000.pdf",height=6.5,width=11)
makePlot(output2_1)
title(main="N=1000",cex.main=2.5)
dev.off()


Cairo::CairoPDF(file="fast_ecp_div_BP_2500.pdf",height=6.5,width=11)
makePlot(output2_2)
title(main="N=2500",cex.main=2.5)
dev.off()

Cairo::CairoPDF(file="fast_ecp_div_BP_5000.pdf",height=6.5,width=11)
makePlot(output2_3)
