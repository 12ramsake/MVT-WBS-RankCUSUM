...
makePlot(output2[,1:36])
makePlot(output2[,37:72])
...
Cairo::CairoPDF(file="ecp_div_BP_1000.pdf",height=6.5,width=11)
makePlot(output2_1)
title(main="N=1000",cex.main=2.5)
dev.off()


Cairo::CairoPDF(file="ecp_div_BP_2500.pdf",height=6.5,width=11)
makePlot(output2_2)
