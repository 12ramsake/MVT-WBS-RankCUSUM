...
#results dirrectory
dirr<- "/u4/k3ramsay/ResearchDocuments/output/Data Files/"
setwd(dirr)
...
for(i in 1:numUniqueRuns){
  ...
  fileName<-paste0(N,"_",length(theta),"_",dName,"_",d,"_",numInt,"_","thresh",thresh,"_Sch_ranks_simsize_",sim.size,sep="")
